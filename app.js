const tg = window.Telegram?.WebApp;
    ...
    const WEBAPP_T = {
        ...
        'ru': {
            ...
            'report_btn_title': 'Пожаловаться',
            'report_modal_title': 'Пожаловаться',
            'report_modal_sub': 'По какой причине вы хотите пожаловаться?',
            'report_cat_porn': '🔞 Порнография',
            'report_cat_drugs': '💊 Наркотики',
            'report_cat_violence': '⚔️ Насилие',
            'report_cat_fraud': '🎭 Мошенничество / Фейковая анкета',
            'report_cat_spam': '📢 Спам / Реклама',
            'report_cat_other': '❓ Другая причина',
            'report_comment_placeholder': 'Дополнительный комментарий (необязательно)...',
            'report_submit': 'Отправить',
            'report_sent': '✅ Ваша жалоба принята',
            'report_error': '❌ Ошибка при отправке жалобы',
            'report_select_category': 'Пожалуйста, выберите причину',
        ...
        'kk': {
            ...
            'report_btn_title': 'Шағым беру',
            'report_modal_title': 'Шағым беру',
            'report_modal_sub': 'Қандай себеппен шағымданбақсыз?',
            'report_cat_porn': '🔞 Порнография',
            ...
            'report_comment_placeholder': 'Қосымша түсініктеме (міндетті емес)...',
            'report_submit': 'Жіберу',
            'report_sent': '✅ Сіздің шағымыңыз қабылданды',
            'report_error': '❌ Шағым жіберуде қате',
            'report_select_category': 'Себепті таңдаңыз',
        ...
        'ky': {
            ...
            'report_btn_title': 'Доо берүү',
            'report_modal_title': 'Доо берүү',
            'report_modal_sub': 'Кайсы себептен доо бергиңиз келет?',
            'report_cat_porn': '🔞 Порнография',
            ...
            'report_comment_placeholder': 'Кошумча комментарий (милдеттүү эмес)...',
            'report_submit': 'Жөнөтүү',
            'report_sent': '✅ Сиздин доолуу арызыңыз кабыл алынды',
            'report_error': '❌ Доо жөнөтүүдө ката',
            'report_select_category': 'Себепти тандаңыз',
        ...
        'kaa': {
            ...
            'report_btn_title': 'Shikayat beriw',
            'report_modal_title': 'Shikayat beriw',
            'report_modal_sub': 'Qanday sebepten shikayat qilmaqshisiz?',
            'report_cat_porn': '🔞 Pornografiya',
            ...
            'report_comment_placeholder': 'Qosimsha pikir (májbúri emes)...',
            'report_submit': 'Jiberiw',
            'report_sent': '✅ Shikayatıńız qabıl etildi',
            'report_error': '❌ Shikayat jiberiwde qátelik',
            'report_select_category': 'Sebepti tańlań',
        ...
        'tg': {
            ...
            'report_btn_title': 'Шикоят кардан',
            'report_modal_title': 'Шикоят кардан',
            'report_modal_sub': 'Бо кадом сабаб шикоят карданӣ ҳастед?',
            'report_cat_porn': '🔞 Порнография',
            ...
            'report_comment_placeholder': 'Шарҳи иловагӣ (ихтиёрӣ)...',
            'report_submit': 'Фиристодан',
            'report_sent': '✅ Шикояти шумо қабул карда шуд',
            'report_error': '❌ Хатогӣ ҳангоми фиристодани шикоят',
            'report_select_category': 'Лутфан сабабро интихоб кунед',
        ...
        'en': {
            ...
            'report_btn_title': 'Report',
            'report_modal_title': 'Report',
            'report_modal_sub': 'What is the reason for your report?',
            ...
            'report_comment_placeholder': 'Additional comment (optional)...',
            'report_submit': 'Submit',
            'report_sent': '✅ Your report has been received',
            'report_error': '❌ Error sending report',
            'report_select_category': 'Please select a reason',
