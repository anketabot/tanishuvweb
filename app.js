const tg = window.Telegram?.WebApp;
    ...
    function getCurrentUserId() {
      ...
      const __devParams = new URLSearchParams(window.location.search);
      const __testUserId = __devParams.get('test_user_id');
      if (__testUserId && /^\d+$/.test(__testUserId)) {
        userId = Number(__testUserId);
        console.warn('[TEST MODE] userId URL parametridan olindi:', userId, '- bu FAQAT development uchun, productionda ishlatilmasin.');
      }
      return userId;
    }
    ...
    // === FAQAT TEST/DEVELOPMENT UCHUN ===
    // Telegram tashqarisida (oddiy brauzerda) ochilganda tg.initDataUnsafe bo'sh bo'ladi,
    // shuning uchun userId aniqlanmaydi. Sinab ko'rish uchun URL'ga
    // ?test_user_id=123456 qo'shib ochish mumkin (masalan: index.html?test_user_id=123456).
    // Bu FAQAT userId hali topilmagan holatda ishlaydi - haqiqiy Telegram foydalanuvchilariga
    // hech qanday ta'sir qilmaydi, chunki ular uchun userId yuqorida allaqachon to'g'ri o'rnatiladi.
    if (!userId) {
      const __devParams = new URLSearchParams(window.location.search);
      const __testUserId = __devParams.get('test_user_id');
      if (__testUserId && /^\d+$/.test(__testUserId)) {
    ...
    const WEBAPP_T = {
        ...
        'anon_start_text': 'Istalgan vaqt anonim suhbatdosh toping! Ismi va rasmi siz roziliginizgacha yashirin qoladi.',
        'anon_start_btn': '🔍 Suhbatdosh topish',
        'anon_searching_text': 'Sizga mos suhbatdosh qidirilmoqda...',
        'anon_cancel_search_btn': 'Bekor qilish',
        'anon_profile_incomplete': 'Anonim suhbatdosh topish uchun avval profilingizni to\'ldiring.',
        'user_not_identified': 'Foydalanuvchi aniqlanmadi. Ilovani Telegram ichida qayta oching.',
        'select_language': '🌍 Tilni tanlang',
            ...
            'report_sub': 'Sababni tanlang. Shikoyatingiz maxfiy qoladi.',
            'report_description_placeholder': "Qo'shimcha izoh (ixtiyoriy)...",
            'report_submit': 'Shikoyat yuborish',
            'report_sent': '✅ Shikoyatingiz qabul qilindi',
            'report_already_sent': 'Siz bu foydalanuvchi haqida allaqachon shikoyat yubordingiz',
            ...
            'ban_overlay_title': 'Akkauntingiz vaqtincha cheklangan',
            'ban_overlay_reason_prefix': 'Sabab: ',
            'ban_overlay_until_prefix': 'Cheklov tugash vaqti: ',
            ...
            'lang_name_ru': "Ruscha",
            'lang_name_kk': "Qozoqcha",
            'lang_name_ky': "Qirg'izcha",
            'lang_name_kaa': "Qoraqalpoqcha",
            'lang_name_tg': "Tojikcha",
        ...
        'ru': {
            ...
            'about_placeholder': 'Напишите немного о себе...',
            ...
            'zodiac_match_label': 'совместимость',
            'close_filters': '❌ Закрыть фильтры',
            'lang_uz': "O'zbekcha",
            'lang_ru': 'Русский',
            'lang_kk': 'Қазақша',
            ...
            'lang_name_ky': 'Киргизский',
            'lang_name_kaa': 'Каракалпакский',
            ...
            'anon_title': 'Анонимный собеседник',
            'anon_active_text': 'Чат с анонимным собеседником начался! Имя и фото пока скрыты.',
            'anon_open_btn': '💬 Открыть чат',
            'anon_reveal_btn': 'Открыть профиль',
            'anon_disconnect_btn': 'Отключиться',
            'anon_reveal_both': '🎉 Вы оба согласились! Переход в основной чат...',
            'anon_reveal_waiting': '👀 Вы запросили открытие профиля. Ожидаем ответа собеседника...',
            'anon_reveal_other_requested': '👀 Собеседник хочет открыть профиль. Вы согласны?',
            'anon_revealed_toast': 'Профили открыты! Теперь вы общаетесь в основном чате.',
            'anon_reveal_sent': 'Ваш запрос отправлен. Ожидайте ответа собеседника.',
            'anon_disconnect_confirm': 'Завершить анонимный чат? Все сообщения будут удалены.',
            'anon_disconnected_toast': 'Анонимный чат завершён.',
            'anon_start_text': 'Найдите анонимного собеседника в любое время! Имя и фото останутся скрытыми до вашего согласия.',
            'anon_start_btn': '🔍 Найти собеседника',
            'anon_searching_text': 'Идёт поиск подходящего собеседника...',
            'anon_cancel_search_btn': 'Отменить',
            'anon_profile_incomplete': 'Чтобы найти анонимного собеседника, сначала заполните свой профиль.',
            'report': 'Жалоба',
            'report_title': 'Подать жалобу',
            'report_sub': 'Выберите причину. Ваша жалоба останется конфиденциальной.',
            'report_description_placeholder': 'Дополнительный комментарий (необязательно)...',
            'report_submit': 'Отправить жалобу',
            'report_sent': '✅ Ваша жалоба принята',
            'report_already_sent': 'Вы уже подавали жалобу на этого пользователя',
            ...
            'ban_overlay_title': 'Ваш аккаунт временно ограничен',
            'ban_overlay_reason_prefix': 'Причина: ',
            'ban_overlay_until_prefix': 'Срок окончания ограничения: '
        },
        'kk': {
            ...
            'about_placeholder': 'Өзіңіз туралы қысқаша жазыңыз...',
            ...
            'lang_name_uz': 'Өзбекше',
            'lang_name_ru': 'Орысша',
            'lang_name_kk': 'Қазақша',
            'lang_name_ky': 'Қырғызша',
            'lang_name_kaa': 'Қарақалпақша',
            'lang_name_tg': 'Тәжікше',
            'lang_name_en': 'Ағылшынша',
            ...
            'anon_title': 'Анонимді әңгімелесуші',
            'anon_active_text': 'Анонимді әңгімелесушіңізбен чат басталды! Аты-жөні және суреті әлі жасырын.',
            'anon_open_btn': '💬 Чатты ашу',
            'anon_reveal_btn': 'Профильді ашу',
            'anon_disconnect_btn': 'Ажырату',
            'anon_reveal_both': '🎉 Екеуіңіз де келістіңіз! Негізгі чатқа өтуде...',
            'anon_reveal_waiting': '👀 Сіз профильді ашуды сұрадыңыз. Әңгімелесушіңіздің жауабы күтілуде...',
            'anon_reveal_other_requested': '👀 Әңгімелесушіңіз профильді ашқысы келеді. Сіз де келісесіз бе?',
            'anon_revealed_toast': 'Профильдер ашылды! Енді негізгі чатта сөйлесесіздер.',
            'anon_reveal_sent': 'Сұранысыңыз жіберілді. Әңгімелесушіңіздің жауабын күтіңіз.',
            'anon_disconnect_confirm': 'Анонимді чатты аяқтағыңыз келе ме? Барлық хабарлар өшіріледі.',
            'anon_disconnected_toast': 'Анонимді чат аяқталды.',
            'anon_start_text': 'Кез келген уақытта анонимді әңгімелесуші табыңыз! Аты-жөні мен суреті сіз келіскенге дейін жасырын қалады.',
            'anon_start_btn': '🔍 Әңгімелесуші табу',
            'anon_searching_text': 'Сізге сай әңгімелесуші ізделуде...',
            'anon_cancel_search_btn': 'Бас тарту',
            'anon_profile_incomplete': 'Анонимді әңгімелесуші табу үшін алдымен профиліңізді толтырыңыз.',
            'report': 'Шағым',
            'report_title': 'Шағым жасау',
            'report_sub': 'Себебін таңдаңыз. Шағымыңыз құпия қалады.',
            'report_description_placeholder': 'Қосымша түсініктеме (міндетті емес)...',
            'report_submit': 'Шағымды жіберу',
            'report_sent': '✅ Шағымыңыз қабылданды',
            'report_already_sent': 'Сіз бұл пайдаланушыға қатысты шағымды бұрын жібергенсіз',
            ...
            'ban_overlay_title': 'Аккаунтыңыз уақытша шектелді',
            'ban_overlay_reason_prefix': 'Себебі: ',
            'ban_overlay_until_prefix': 'Шектеу аяқталу уақыты: '
        },
        'ky': {
            ...
            'about_placeholder': 'Өзүңүз жөнүндө кыскача жазыңыз...',
            ...
            'lang_name_uz': 'Өзбекче',
            'lang_name_ru': 'Орусча',
            'lang_name_kk': 'Казакча',
            'lang_name_ky': 'Кыргызча',
            'lang_name_kaa': 'Каракалпакча',
            'lang_name_tg': 'Тажикче',
            'lang_name_en': 'Англисче',
            ...
            'anon_title': 'Аноним маектеш',
            'anon_active_text': 'Аноним маектешиңиз менен маек башталды! Аты жана сүрөтү азырынча жашыруун.',
            'anon_open_btn': '💬 Маекти ачуу',
            'anon_reveal_btn': 'Профильди ачуу',
            'anon_disconnect_btn': 'Ажыратуу',
            'anon_reveal_both': '🎉 Экөөңүз тең макул болдуңуз! Негизги маекке өтүлүүдө...',
            'anon_reveal_waiting': '👀 Сиз профильди ачууну сурадыңыз. Маектешиңиздин жообу күтүлүүдө...',
            'anon_reveal_other_requested': '👀 Маектешиңиз профильди ачууну каалайт. Сиз да макулсузбу?',
            'anon_revealed_toast': 'Профилдер ачылды! Эми негизги маекте сүйлөшөсүздөр.',
            'anon_reveal_sent': 'Сурооңуз жөнөтүлдү. Маектешиңиздин жообун күтүңүз.',
            'anon_disconnect_confirm': 'Аноним маекти аякташыңыз келеби? Бардык билдирүүлөр өчүрүлөт.',
            'anon_disconnected_toast': 'Аноним маек аяктады.',
            'anon_start_text': 'Каалаган убакта аноним маектеш табыңыз! Аты жана сүрөтү сиз макул болгонго чейин жашыруун калат.',
            'anon_start_btn': '🔍 Маектеш табуу',
            'anon_searching_text': 'Сизге ылайыктуу маектеш изделүүдө...',
            'anon_cancel_search_btn': 'Жокко чыгаруу',
            'anon_profile_incomplete': 'Аноним маектеш табуу үчүн алгач профилиңизди толтуруңуз.',
            'report': 'Даттануу',
            'report_title': 'Даттануу берүү',
            'report_sub': 'Себебин тандаңыз. Даттанууңуз купуя бойдон калат.',
            'report_description_placeholder': 'Кошумча түшүндүрмө (милдеттүү эмес)...',
            'report_submit': 'Даттанууну жөнөтүү',
            'report_sent': '✅ Даттанууңуз кабыл алынды',
            'report_already_sent': 'Сиз бул колдонуучу тууралуу мурда эле даттануу жөнөткөнсүз',
            ...
            'ban_overlay_title': 'Аккаунтуңуз убактылуу чектелди',
            'ban_overlay_reason_prefix': 'Себеби: ',
            'ban_overlay_until_prefix': 'Чектөө аяктоо убактысы: '
        },
        'kaa': {
            ...
            'about_placeholder': 'Ózińiz haqqında qısqasha jazıń...',
            ...
            'lang_name_uz': 'Ózbekshe',
            'lang_name_ru': 'Rússha',
            'lang_name_kk': 'Qazaqsha',
            'lang_name_ky': 'Qırgızsha',
            'lang_name_kaa': 'Qaraqalpaqsha',
            'lang_name_tg': 'Tájikshe',
            'lang_name_en': "Aǵılshınsha",
            ...
            'anon_title': 'Anonim sáwbetlesiwshi',
            'anon_active_text': 'Anonim sáwbetlesiwshińiz benen chat baslandı! Atı hám súwreti háli jasırın.',
            'anon_open_btn': '💬 Sáwbetti ashıw',
            'anon_reveal_btn': 'Profildi ashıw',
            'anon_disconnect_btn': 'Ajıratıw',
            'anon_reveal_both': '🎉 Ekewińiz de razı boldıńız! Tiykarǵı chatqa ótkeriliwde...',
            'anon_reveal_waiting': '👀 Siz profildi ashıwdı soradıńız. Sáwbetlesiwshińizdiń juwabı kútilmekte...',
            'anon_reveal_other_requested': '👀 Sáwbetlesiwshińiz profildi ashıwdı qáleydi. Siz de razımısız?',
            'anon_revealed_toast': 'Profiller ashıldı! Endi tiykarǵı chatta sáwbetlesesiz.',
            'anon_reveal_sent': 'Soraw jiberildi. Sáwbetlesiwshińizdiń juwabın kútiń.',
            'anon_disconnect_confirm': 'Anonim sáwbetti juwmaqlamaqshımısız? Barlıq xabarlar óshirilip ketedi.',
            'anon_disconnected_toast': 'Anonim sáwbet juwmaqlandı.',
            'anon_start_text': 'Qálegen waqıtta anonim sáwbetlesiwshi tabıń! Atı hám súwreti siz razılıq bergenshe jasırın qaladı.',
            'anon_start_btn': '🔍 Sáwbetlesiwshi tabıw',
            'anon_searching_text': 'Sizge sáykes sáwbetlesiwshi izlenbekte...',
            'anon_cancel_search_btn': 'Biykarlaw',
            'anon_profile_incomplete': 'Anonim sáwbetlesiwshi tabıw ushın áwele profilińizdi tolıqtırıń.',
            'report': 'Shikayat',
            'report_title': 'Shikayat qılıw',
            'report_sub': 'Sebepti tańlań. Shikayatıńız máxpiy qaladı.',
            'report_description_placeholder': 'Qosımsha túsinik (májbúriy emes)...',
            'report_submit': 'Shikayat jiberiw',
            'report_sent': '✅ Shikayatıńız qabıl etildi',
            'report_already_sent': 'Siz bul paydalanıwshı haqqında aldın-ala shikayat jibergensiz',
            'report_error': '❌ Shikayat jiberiwde qátelik',
            'report_cat_porn': '🔞 Pornografiya',
            ...
            'ban_overlay_title': 'Akkauntıńız waqtınsha sheklendi',
            'ban_overlay_reason_prefix': 'Sebebi: ',
            'ban_overlay_until_prefix': 'Sheklew tamamlanıw waqtı: '
        },
        'tg': {
            ...
            'about_placeholder': 'Дар бораи худатон мухтасар нависед...',
            ...
            'lang_name_ru': 'Русӣ',
            'lang_name_kk': 'Қазоқӣ',
            'lang_name_ky': 'Қирғизӣ',
            'lang_name_kaa': 'Қароқалпоқӣ',
            'lang_name_tg': 'Тоҷикӣ',
            'lang_name_en': 'Англисӣ',
            ...
            'anon_title': 'Ҳамсуҳбати ношинос',
            'anon_active_text': 'Чат бо ҳамсуҳбати ношиносатон оғоз шуд! Ном ва акс ҳанӯз пинҳон аст.',
            'anon_open_btn': '💬 Кушодани чат',
            'anon_reveal_btn': 'Кушодани профил',
            'anon_disconnect_btn': 'Қатъ кардан',
            'anon_reveal_both': '🎉 Ҳар дуятон розӣ шудед! Ба чати асосӣ гузаронида мешавад...',
            'anon_reveal_waiting': '👀 Шумо дархости кушодани профилро додед. Ҷавоби ҳамсуҳбататон интизор аст...',
            'anon_reveal_other_requested': '👀 Ҳамсуҳбататон мехоҳад профилро кушояд. Шумо ҳам розӣ ҳастед?',
            'anon_revealed_toast': 'Профилҳо кушода шуданд! Ҳоло дар чати асосӣ гуфтугӯ мекунед.',
            'anon_reveal_sent': 'Дархости шумо фиристода шуд. Ҷавоби ҳамсуҳбататонро интизор шавед.',
            'anon_disconnect_confirm': 'Мехоҳед чати ношиносро хотима диҳед? Ҳамаи паёмҳо нест мешаванд.',
            'anon_disconnected_toast': 'Чати ношинос хотима ёфт.',
            'anon_start_text': 'Дар ҳар вақт ҳамсуҳбати ношинос ёбед! Ном ва акс то розигии шумо пинҳон мемонад.',
            'anon_start_btn': '🔍 Ёфтани ҳамсуҳбат',
            'anon_searching_text': 'Ҳамсуҳбати мувофиқ ҷустуҷӯ мешавад...',
            'anon_cancel_search_btn': 'Бекор кардан',
            'anon_profile_incomplete': 'Барои ёфтани ҳамсуҳбати ношинос аввал профили худро пур кунед.',
            'report': 'Шикоят',
            'report_title': 'Шикоят кардан',
            'report_sub': 'Сабабро интихоб кунед. Шикояти шумо махфӣ мемонад.',
            'report_description_placeholder': 'Шарҳи иловагӣ (ихтиёрӣ)...',
            'report_submit': 'Фиристодани шикоят',
            'report_sent': '✅ Шикояти шумо қабул шуд',
            'report_already_sent': 'Шумо аллакай дар бораи ин корбар шикоят фиристодед',
            ...
            'ban_overlay_title': 'Ҳисоби шумо муваққатан маҳдуд шудааст',
            'ban_overlay_reason_prefix': 'Сабаб: ',
            'ban_overlay_until_prefix': 'Вақти анҷоми маҳдудият: '
        },
        'en': {
            ...
            'about_placeholder': 'Write a short bio about yourself...',
            ...
            'anon_title': 'Anonymous chat partner',
            'anon_active_text': 'Your anonymous chat has started! Name and photo are still hidden.',
            'anon_open_btn': '💬 Open chat',
            'anon_reveal_btn': 'Reveal profile',
            'anon_disconnect_btn': 'Disconnect',
            'anon_reveal_both': "🎉 You both agreed! Moving to the main chat...",
            'anon_reveal_waiting': "👀 You asked to reveal your profile. Waiting for your partner's response...",
            'anon_reveal_other_requested': '👀 Your partner wants to reveal their profile. Do you agree?',
            'anon_revealed_toast': 'Profiles revealed! Now you can chat in the main chat.',
            'anon_reveal_sent': 'Your request was sent. Waiting for a response from your partner.',
            'anon_disconnect_confirm': 'End the anonymous chat? All messages will be deleted.',
            'anon_disconnected_toast': 'Anonymous chat ended.',
            'anon_start_text': 'Find an anonymous chat partner anytime! Name and photo stay hidden until you agree to reveal them.',
            'anon_start_btn': '🔍 Find a partner',
            'anon_searching_text': 'Looking for a matching partner...',
            'anon_cancel_search_btn': 'Cancel',
            'anon_profile_incomplete': 'Please complete your profile first to find an anonymous chat partner.',
            'report': 'Report',
            'report_title': 'Report user',
            'report_sub': 'Choose a reason. Your report stays confidential.',
            'report_description_placeholder': 'Additional comment (optional)...',
            'report_submit': 'Submit report',
            'report_sent': '✅ Your report has been received',
            'report_already_sent': 'You have already reported this user',
            ...
            'ban_overlay_title': 'Your account is temporarily restricted',
            'ban_overlay_reason_prefix': 'Reason: ',
            'ban_overlay_until_prefix': 'Restriction ends: '
        },
    };
    ...
    function refreshLocationDropdownsForLang() {
      ...
      // ── Trigger LABEL larini (Davlat / Viloyat / Tuman so'zlarini) yangilash ──
      const labelMap = {
        'inp-country':  tr('country_label')   || 'Davlat',
        'inp-region':   tr('region_label')    || 'Viloyat',
        'inp-district': tr('district_label')  || 'Tuman / Shahar',
        'sf-country':   tr('country_label')   || 'Davlat',
        'sf-region':    tr('region_label')    || 'Viloyat',
        'sf-district':  tr('district_label')  || 'Tuman / Shahar',
      };
      Object.entries(labelMap).forEach(([id, label]) => {
        const trigger = document.getElementById(id + '-trigger');
        if (trigger) {
          const labelEl = trigger.querySelector('.loc-trigger-label');
  ...
  // initLanguage - Promise qaytaradi, DOMContentLoaded await qilishi uchun
    ...
    let messageTargetCanWrite = false;
    ...
    function openMessageModal(toUserId, name, photo, canWrite) {
      ...
      messageTargetCanWrite = !!canWrite;
    ...
    async function sendFirstMessage() {
      ...
      const alreadyCanWrite = messageTargetCanWrite;
      ...
      // Xabar limit tekshirish (like limitiga bog'liq emas)
      ...
      // 1. Agar ikkalamiz allaqachon match bo'lgan bo'lsak (yoki bo'lish
      // mumkin bo'lsa) — xabarni to'g'ridan-to'g'ri chatga yuboramiz.
      // Bu like bosish yoki like limitiga umuman bog'liq emas.
      let matchId = null;
      try {
        let canWriteNow = alreadyCanWrite;
        if (!canWriteNow) {
          const cw = await apiPost('/api/can_write', { from_user: fromUserId, to_user: toUserId });
          canWriteNow = !!(cw && cw.can_write);
        }
        if (canWriteNow) {
          const initData = await apiPost('/api/initiate_chat', { from_user: fromUserId, to_user: toUserId });
          if (initData && initData.success && initData.match_id) {
            matchId = initData.match_id;
          }
        }
      } catch(e) {}
      ...
      if (matchId) {
        ...
        if (chatData.success) {
          ...
          loadChats();
          openChatRoom(matchId, savedName, savedPhoto);
        } else {
          showToast(tr('message_sent'));
          loadChats();
        }
      } else {
        // 2. Hali match bo'lmagan — shunga qaramay xabar yuborilgach
        // backend darhol haqiqiy chat (match) ochadi, shuning uchun
        // suhbatni ikkala tomon uchun ham Chat bo'limida ko'rsatamiz.
        try {
          const pendingData = await apiPost('/api/messages/send_pending', {
            from_user: fromUserId,
            to_user: toUserId,
            message: message
          });
          if (pendingData && pendingData.error === 'limit_exceeded') {
            showLimitExceeded('messages');
          } else if (pendingData && pendingData.success && pendingData.match_id) {
            showToast(tr('message_sent'));
            loadChats();
            openChatRoom(pendingData.match_id, savedName, savedPhoto);
          } else {
            showToast(tr('message_sent'));
            loadChats();
          }
        } catch(e) {
          showToast(tr('error_prefix') + tr('like_not_sent'));
        }
      }

      // 3. Like'ni fonda, alohida (xatolik bo'lsa ham xabarga ta'sir qilmaydi)
      // yuboramiz - shunda mutual bo'lganda oddiy match jarayoni ham ishlaydi.
      try {
        const likeData = await apiPost('/api/likes/send', {
          from_user: fromUserId,
          to_user: toUserId
        });
        if (likeData && likeData.success) {
      ...
      // Lokalda zaxira (chat oynasi darhol yangilanishi uchun)
      try {
    ...
    function populateProfileForm(profile) {
      ...
      if (profile.goals && Array.isArray(profile.goals)) {
        ...
        document.querySelectorAll('#goals-chips .chip').forEach(chip => {
          const chipKey = chip.getAttribute('data-i18n-chip');
          chip.classList.toggle('selected', selectedGoals.includes(chipKey));
        });
      }
    ...
    function _translateCountryValue(value, lang) {
      ...
      const MAP = {
        ...
        "Дигар": 'country_other',
        "Hindiston": 'country_in', "Индия": 'country_in',
        "India": 'country_in', "India": 'country_in',
      };
    ...
    function getCountriesList(includeAll = false) {
      const countryEntries = [
        ...
        { value: "Hindiston",    key: 'country_in', flag: "🇮🇳" },
        { value: "Boshqa",       key: 'country_other', flag: "🌍" },
      ];

      const list = countryEntries.map(c => ({ value: c.value, label: tr(c.key) || c.value, flag: c.flag }));
      if (includeAll) {
    ...
    const COUNTRIES = [
      ...
      { value: "Hindiston",    label: "Hindiston",    flag: "🇮🇳" },
    ...
    // Davlat uchun to'liq dataset va tarjimalangan options qaytaruvchi helper
    function _getLocOptsForCountry(country) {
      const lang = currentLang || 'uz';
      const fn = COUNTRY_DATASET_MAP[country] || COUNTRY_DATASET_MAP[country?.trim()];
      if (!fn) return null;
      const fullDs = fn();
      if (!fullDs) return null;
      const uzDs   = fullDs['uz'] || {};
      const langDs = fullDs[lang] || fullDs['uz'] || {};
      const uzKeys   = Object.keys(uzDs);
      const langKeys = Object.keys(langDs);
      // value = uzKey (doim), label = langKey (joriy tilda)
      return uzKeys.map((uzKey, i) => ({ value: uzKey, label: langKeys[i] || uzKey }));
    }

    // Viloyat uchun tuman options (value=uzDistrict, label=langDistrict)
    function _getDistrictOpts(country, uzRegion) {
      const lang = currentLang || 'uz';
      const fn = COUNTRY_DATASET_MAP[country] || COUNTRY_DATASET_MAP[country?.trim()];
      if (!fn) return [];
      const fullDs = fn();
      ...
      const uzKeys   = Object.keys(uzDs);
      const langKeys = Object.keys(langDs);
      const uzIdx    = uzKeys.indexOf(uzRegion);
      const uzDists  = uzDs[uzRegion] || [];
      const langDists = (uzIdx !== -1 && langKeys[uzIdx]) ? (langDs[langKeys[uzIdx]] || uzDists) : uzDists;
      return uzDists.map((uzD, i) => ({ value: uzD, label: langDists[i] || uzD }));
    }
    ...
    function onRegionChange() {
      ...
      if (region) {
        ...
        if (distOpts.length > 0) {
          rebuildLocOptions('inp-district', distOpts, false);
    ...
    function onSearchRegionChange() {
      ...
      if (region) {
        const distOpts = _getDistrictOpts(country, region);
        if (distOpts.length > 0) {
          rebuildLocOptions('sf-district', distOpts, false);
      ...
      loadRegionsData().then(() => {
        ...
        if (cityStr.includes('||')) {
          ...
          if (commaSplit.length >= 2) {
            ...
            // Davlat yoki viloyat
            const COUNTRIES_LIST = ["O\u02bbzbekiston","Rossiya","Qozog\u02bbiston","Qirg\u02bbiziston","Tojikiston","Turkmaniston","Ozarbayjon","Armaniston","Gruziya","Ukraina","Belarus","Moldova","Hindiston","Boshqa"];
    ...
    function doSearch() {
      ...
      if (modal) modal.style.display = 'flex';
      const headerReportBtnLoading = document.getElementById('results-report-btn');
    ...
    function renderTinderCardInModal(direction) {
      ...
      if (tinderIndex >= tinderUsers.length) {
        const headerReportBtnEnd = document.getElementById('results-report-btn');
            ...
            <div class="tinder-photo-info">
              ...
              <div class="tinder-actions" onclick="event.stopPropagation()">
                <button class="tinder-btn tinder-btn-back" onclick="tinderBackModal()" title="${tr('btn_back')}">
                  <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.6" stroke-linecap="round" stroke-linejoin="round"><path d="M3 12h18M3 12l6-6M3 12l6 6"/></svg>
                </button>
                <button class="tinder-btn tinder-btn-nope" onclick="tinderSwipeModal('left')" title="O'tkazib yuborish">
                  <svg width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.6" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg>
                </button>
                <button class="tinder-btn tinder-btn-msg" onclick="openMessageModalFromTinder(${u.telegram_id},'${escapeJs(u.full_name)}')" title="Xabar">
                  <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>
                </button>
                <button class="tinder-btn tinder-btn-like" onclick="tinderSwipeModal('right')" title="${tr('like')}">
                  <svg width="36" height="36" viewBox="0 0 24 24" fill="currentColor" stroke="none"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/></svg>
                </button>
                <button class="tinder-btn tinder-btn-superlike" onclick="tinderSuperLikeModal()" title="${tr('super_like')}">
                  <svg width="34" height="34" viewBox="0 0 24 24" fill="currentColor" stroke="none"><path d="M12 2.5l3.09 6.26L22 9.77l-5 4.87 1.18 6.88L12 18.27l-6.18 3.25L7 14.64 2 9.77l6.91-1.01L12 2.5z"/></svg>
                </button>
              </div>
            </div>
          </div>
      ...
      const headerReportBtn = document.getElementById('results-report-btn');
      if (headerReportBtn) {
    ...
    const REPORT_CATEGORIES = ['porn', 'drugs', 'violence', 'fraud', 'minor', 'other'];
    let reportContext = { reportedId: null, source: null, category: null };

    function openReportModal(reportedId, source) {
      if (!userId) return;
      reportContext = { reportedId: reportedId ? Number(reportedId) : null, source, category: null };
    ...
    function closeReportModal(event) {
      ...
      reportContext = { reportedId: null, source: null, category: null };
    }

    function collectReportContextMessages() {
      // Suhbatdagi so'nggi xabarlar AI tekshiruvi uchun kontekst sifatida yuboriladi
      try {
        if (reportContext.source === 'chat' && Array.isArray(lastLoadedChatMessages)) {
          return lastLoadedChatMessages
            .filter(m => currentChatPartner && currentChatPartner.user && Number(m.sender_id) === Number(currentChatPartner.user.telegram_id))
            .map(m => m.message)
            .slice(-20);
        }
        if (reportContext.source === 'anon_chat' && Array.isArray(lastLoadedAnonMessages)) {
          return lastLoadedAnonMessages
            .map(m => m.message)
            .slice(-20);
        }
      } catch (e) {}
    ...
    async function submitReport() {
      if (!userId || !reportContext.category) return;
      const submitBtn = document.getElementById('report-submit-btn');
      ...
      const body = {
        ...
        messages: collectReportContextMessages(),
      };
      if (reportContext.source === 'anon_chat') {
        body.anon_match_id = currentAnonMatchId;
      } else {
        body.reported_id = reportContext.reportedId;
      }

      const data = await apiPost('/api/report', body);
      closeReportModal();

      if (data && data.success) {
        showToast(data.already_reported ? tr('report_already_sent') : tr('report_sent'));
      } else {
    ...
    function showBanOverlay(ban) {
      ...
      const untilEl = document.getElementById('ban-overlay-until');
      if (reasonEl) reasonEl.textContent = tr('ban_overlay_reason_prefix') + (ban.ban_reason || '');
      if (untilEl && ban.banned_until) {
        try {
          const untilDate = new Date(ban.banned_until);
          untilEl.textContent = tr('ban_overlay_until_prefix') + untilDate.toLocaleString();
        } catch (e) {
          untilEl.textContent = tr('ban_overlay_until_prefix') + ban.banned_until;
        }
      }
      overlay.style.display = 'flex';
      // Ban ekrani ustidan hech narsa ko'rinmasligi uchun asosiy interfeysni yashiramiz
      document.querySelectorAll('.bottom-nav, .page').forEach(el => { el.style.display = 'none'; });
    }
    ...
    async function fetchUserProfile(telegramId) {
      ...
      if (data.success && data.ban && data.ban.banned) {
        showBanOverlay(data.ban);
      }
    ...
    async function loadChatMessages(matchId) {
      const data = await apiPost('/api/chat/messages', { match_id: matchId, telegram_id: userId });
      const container = document.getElementById('chat-messages');
    ...
    function toggleEmojiPanel(panelId) {
      const panel = document.getElementById(panelId || 'emoji-panel');
    ...
    let anonInQueue = false; // joriy holat: navbatda turibmizmi (tezroq polling uchun)
    let anonStatusRequestSeq = 0; // eski (kech kelgan) javoblar yangi holatni bosib ketmasligi uchun

    function scheduleAnonPolling() {
      if (anonStatusPollInterval) clearInterval(anonStatusPollInterval);
      // Navbatda turganda tez-tez (har 3 soniyada) tekshiramiz, shunda backend
      // juftlashtirgan zahoti (matcher har 8 soniyada ishlaydi) chat darhol ochiladi.
      // Navbatda bo'lmasa, kamroq tez-tez (20 soniyada) tekshiraveramiz.
      const intervalMs = anonInQueue ? 3000 : 20000;
      anonStatusPollInterval = setInterval(checkAnonStatus, intervalMs);
    }
    ...
    async function checkAnonStatus() {
      ...
      // Har bir so'rovga o'z tartib raqamini beramiz. Tarmoq kechikishi tufayli
      // javoblar yuborilgan tartibda qaytmasligi mumkin - masalan, navbatga
      // qo'shilishdan OLDIN yuborilgan eski so'rov javobi, navbatga qo'shilgandan
      // KEYIN kelib qolsa, u banner'ni noto'g'ri ravishda "band emas" holatiga
      // qaytarib yuborar edi. Shu sababli faqat ENG OXIRGI so'rovning javobini
      // qabul qilamiz, qolganlarini e'tiborsiz qoldiramiz.
      const mySeq = ++anonStatusRequestSeq;
      const data = await apiPost('/api/anon/status', { telegram_id: telegramId });
      if (mySeq !== anonStatusRequestSeq) return; // bu javob eskirib qolgan, e'tiborsiz qoldiramiz
      if (!data.success) return;

      const anon = data.anon;
      const inQueue = !!data.in_queue;
      renderAnonBanner(anon, inQueue);

      if (inQueue !== anonInQueue) {
        anonInQueue = inQueue;
        scheduleAnonPolling(); // navbat holati o'zgardi - polling tezligini moslashtiramiz
      }
      ...
      } else if (anon && anon.status === 'active' && anon.anon_match_id) {
        // Bu tomon hozircha faqat navbatda kutib turgan edi (chatni o'zi
        // ochmagan), lekin backend uni allaqachon kimdir bilan juftlagan.
        // Qo'lda "Ochish" tugmasini bosishni kutmasdan, chatni ikkala
        // tomon uchun ham darhol avtomatik ochamiz.
        openAnonChatRoom(anon.anon_match_id);
      }
    }

    function renderAnonBanner(anon, inQueue) {
      const banner = document.getElementById('anon-banner');
      if (!banner) return;

      // Anonim suhbat bo'limi endi doim ko'rinadi - foydalanuvchi istalgan vaqt
      // "Suhbatdosh topish" tugmasini bosib qidira oladi. Qabul qilish/rad etish
      // kerak emas: ikkita mos (turli jinsdagi) qidiruvchi topilgan zahoti chat
      // avtomatik ochiladi.
      banner.style.display = 'block';

      if (anon && anon.status === 'active') {
        banner.innerHTML = `
        ...
        banner.innerHTML = `
          ...
          <div class="anon-banner-text">
            <span class="anon-searching-spinner"></span>${tr('anon_searching_text')}
          </div>
          <div class="anon-banner-actions">
            <button class="anon-banner-btn anon-banner-btn-decline" onclick="cancelAnonQueue()">${tr('anon_cancel_search_btn')}</button>
          </div>
        `;
      } else {
        banner.innerHTML = `
          <div class="anon-banner-title">🌙 ${tr('anon_title')}</div>
          <div class="anon-banner-text">${tr('anon_start_text')}</div>
          <div class="anon-banner-actions">
            <button id="anon-join-btn" class="anon-banner-btn anon-banner-btn-open" onclick="joinAnonQueue()">${tr('anon_start_btn')}</button>
          </div>
        `;
      }
    }

    async function joinAnonQueue() {
      const telegramId = getCurrentUserId();
      if (!Number.isFinite(telegramId) || telegramId <= 0) {
        console.error('joinAnonQueue: userId aniqlanmagan yoki noto\'g\'ri', { userId });
        showToast(tr('user_not_identified') || tr('profile_not_loaded'));
        return;
      }

      // Darhol (server javobini kutmasdan) tugmani bloklab, foydalanuvchiga
      // bosilgani sezilishi uchun vizual feedback beramiz. Aks holda sekin
      // internetda foydalanuvchi "ishlamayapti" deb bir necha marta bosaveradi.
      const joinBtn = document.getElementById('anon-join-btn');
      if (joinBtn) {
        joinBtn.disabled = true;
        joinBtn.textContent = tr('anon_searching_text');
      }

      let data;
      try {
        data = await apiPost('/api/anon/queue/join', { telegram_id: telegramId });
      } catch (e) {
        console.error('joinAnonQueue: tarmoq xatolik', e);
        data = { success: false, error: e?.message };
      }

      if (!data || !data.success) {
        console.error('joinAnonQueue: API xatolik', data);
        const reason = (data?.message || data?.error || '').toString();
        // Xatolik bo'lsa, tugmani asl holatiga qaytaramiz - aks holda
        // foydalanuvchi doim bloklangan tugma bilan qolib ketadi.
        if (joinBtn) {
          joinBtn.disabled = false;
          joinBtn.textContent = tr('anon_start_btn');
        }
        if (/profil/i.test(reason)) {
          showPage('profile');
        }
        showToast(reason || tr('anon_profile_incomplete') || tr('please_fill_profile'));
        return;
      }
      if (data.anon && data.anon.status === 'active') {
        showToast('🎉 ' + tr('anon_active_text'));
        openAnonChatRoom(data.anon.anon_match_id);
        return;
      }
      showToast(tr('anon_searching_text'));
      // Serverdan tasdiq keldi - navbatga qo'shildik. Banner'ni darhol
      // "qidirilmoqda" holatiga o'tkazamiz va pollingni tezlashtiramiz, shunda
      // eski (sekin) 20 soniyalik interval endi bu holatni bosib ketmaydi.
      anonInQueue = true;
      renderAnonBanner(null, true);
      scheduleAnonPolling();
      checkAnonStatus();
    }

    async function cancelAnonQueue() {
      const telegramId = getCurrentUserId();
      if (!Number.isFinite(telegramId) || telegramId <= 0) {
        console.error('cancelAnonQueue: userId aniqlanmagan yoki noto\'g\'ri', { userId });
        return;
      }
      const cancelBtn = document.querySelector('.anon-banner-btn-decline');
      if (cancelBtn) cancelBtn.disabled = true;
      try {
        await apiPost('/api/anon/queue/leave', { telegram_id: telegramId });
      } catch (e) {
        console.error('cancelAnonQueue: tarmoq xatolik', e);
      }
      anonInQueue = false;
      renderAnonBanner(null, false);
      scheduleAnonPolling();
      checkAnonStatus();
    }
    ...
    async function loadAnonChatMessages() {
      ...
      const container = document.getElementById('anon-chat-messages');
      if (!data.success || !container) return;
      lastLoadedAnonMessages = data.messages || [];
      container.innerHTML = data.messages.map(m => renderChatBubbleHTML(m, m.sender_id == userId)).join('');
      container.scrollTop = container.scrollHeight;
    }
    ...
    async function sendAnonImageMessage(input) {
      // Rasm yuborish - asosiy chatdagi kabi base64 orqali
      const file = input.files[0];
      if (!file || !currentAnonMatchId) return;
    ...
    // Sarlavhadagi shikoyat tugmasi bosilganda ishlaydi (xavfsizlik uchun
    // zaxira variant — asosiy holatda renderTinderCardInModal() tugmaga
    // to'g'ridan-to'g'ri onclick biriktirib qo'yadi).
    ...
    // === XAVFSIZLIK: rasm/skrinshot saqlashni qiyinlashtirish ===
    // ESLATMA: veb-texnologiyalarda (shu jumladan Telegram Mini App) tizim
    // skrinshotini yoki ekran yozib olishni 100% bloklash IMKONSIZ - bu faqat
    // operatsion tizim darajasida (native ilova) amalga oshirilishi mumkin.
    // Quyidagilar faqat tasodifiy/qulay nusxalashning oldini oladi va
    // skrinshot urinishlarini qiyinlashtiradi. Asosiy himoya - watermark
    // (har bir rasmga server tomonda kuydiriladi, bot.py->watermark_image_base64).
    function initScreenshotDeterrents() {
      // Long-press orqali rasmni saqlash/nusxalash menyusini o'chirish
      document.addEventListener('contextmenu', (e) => {
        if (e.target && (e.target.tagName === 'IMG' || e.target.closest('.photo-viewer, .profile-photo, .user-photo'))) {
          e.preventDefault();
        }
      });

      // Rasmlarni drag qilib saqlashni o'chirish
      ...
      // Ilova fon rejimiga o'tganda (boshqa ilova ochilganda, taskswitcher,
      // ba'zi qurilmalarda ekran yozib olish boshlanganda) nozik rasmlarni
      // vaqtincha xiraytirish
      document.addEventListener('visibilitychange', () => {
        document.body.classList.toggle('privacy-blur', document.hidden);
      });
    }
    initScreenshotDeterrents();
    ...
    document.addEventListener('DOMContentLoaded', async () => {
        ...
        // Til yuklangandan so'ng dropdown labellarini (Davlat/Viloyat/Tuman) tarjima qilish
        loadRegionsData().then(() => {
          refreshLocationDropdownsForLang();
        });
    ...
    // Matnni tozalash: suffix va maxsus belgilarni olib tashlash
    function _cleanLocName(s) {
      if (!s) return '';
      return String(s)
        .toLowerCase()
        .replace(/viloyati?|shahari?|tumani?|shahri?|oblasti?|область|район|город|region|district|city|province|province/gi, '')
        .replace(/[''`ʻʼ]/g, '')
        .replace(/\s+/g, ' ')
        .trim();
    }
    ...
    // Barcha tillardagi nomlar bo'yicha qidiradi, natijani UZ kalitiga qaytaradi
    function _matchGeoToRegions(nominatimAddr) {
      ...
      // Nominatim dan kelgan barcha joy nomlarini yig'ish
      const rawCandidates = [
        nominatimAddr.state, nominatimAddr.region,
        nominatimAddr.county, nominatimAddr.city,
        nominatimAddr.town, nominatimAddr.village,
        nominatimAddr.hamlet, nominatimAddr.suburb,
        nominatimAddr.city_district
      ].filter(Boolean);

      // Har bir kandidatni tozalash
      const cleanedCandidates = rawCandidates.map(c => _cleanLocName(c));

      // Barcha tillardagi viloyat nomlarini to'plash: { langKey: [regionNames] }
      // va teskari map: cleanedName -> uzRegionKey
      const regionCleanToUz = {}; // cleaned(anyLangRegion) -> uzRegion
      const uzRegions = ds['uz'] || {};

      const uzKeys   = Object.keys(uzRegions);
      Object.keys(ds).forEach(lang => {
        const langRegions = ds[lang] || {};
        const langKeys = Object.keys(langRegions);
        langKeys.forEach((langRegion, idx) => {
          const cleaned = _cleanLocName(langRegion);
          if (cleaned && uzKeys[idx]) {
            regionCleanToUz[cleaned] = uzKeys[idx];
          }
        });
      });

      // Viloyatni topish: har bir rawCandidate ni barcha lang regionlar bilan solishtir
      function _findRegion() {
        for (const cand of cleanedCandidates) {
          if (!cand) continue;
          // To'g'ridan-to'g'ri moslik
          if (regionCleanToUz[cand]) return regionCleanToUz[cand];
          // Qisman moslik
          for (const [cleaned, uzKey] of Object.entries(regionCleanToUz)) {
            if (!cleaned) continue;
            if (cand.includes(cleaned) || cleaned.includes(cand)) {
              return uzKey;
            }
          }
        }
      ...
      // Tumanni topish: uzRegion ostidagi barcha tillardagi tuman nomlarini solishtir
      function _findDistrict(uzRegion) {
        if (!uzRegion) return null;
        const uzIdx = uzKeys.indexOf(uzRegion);
        if (uzIdx === -1) return null;

        // Barcha tillardagi tuman nomlarini yig'ish: cleanedName -> uzDistrictName
        const districtCleanToUz = {};
        const uzDistricts = uzRegions[uzRegion] || [];

        Object.keys(ds).forEach(lang => {
          const langRegions = ds[lang] || {};
          const langKeys2 = Object.keys(langRegions);
          if (!langKeys2[uzIdx]) return;
          const langDistricts = langRegions[langKeys2[uzIdx]] || [];
          langDistricts.forEach((ld, di) => {
            const cleaned = _cleanLocName(ld);
            if (cleaned && uzDistricts[di]) {
              districtCleanToUz[cleaned] = uzDistricts[di];
            }
          });
        });

        // Nominatim kandidatlaridan tuman topish
        for (const cand of cleanedCandidates) {
          if (!cand) continue;
          if (districtCleanToUz[cand]) return districtCleanToUz[cand];
          for (const [cleaned, uzDist] of Object.entries(districtCleanToUz)) {
            if (!cleaned) continue;
            if (cand.includes(cleaned) || cleaned.includes(cand)) {
              return uzDist;
            }
    ...
    function _autoFillLocationFromGeo(matchedLoc, rawNominatimAddr) {
      ...
      // DS getter - har doim to'liq dataset (barcha tillar)
      const DS_MAP = {
        "Oʻzbekiston": () => uzbekCitiesML,
        "O'zbekiston": () => uzbekCitiesML,
        "Rossiya":       () => russiaCitiesML,
      ...
      loadRegionsData().then(() => {
        ...
        if (country) {
          ...
          const cLabel = _translateCountryValue(country, lang);
          const cValEl = document.getElementById('inp-country-trigger-val');
          if (cValEl) { cValEl.textContent = cLabel; cValEl.classList.remove('placeholder'); }
          document.getElementById('inp-country-trigger')?.classList.add('filled');
          document.querySelectorAll('#inp-country-opts .loc-option').forEach(o =>
            o.classList.toggle('selected', o.dataset.value === country));
        }

        const fullDs = DS_MAP[country] ? DS_MAP[country]() : null;
        // UZ kalit ro'yxati (value sifatida ishlatamiz)
        const uzDs   = fullDs ? (fullDs['uz'] || {}) : {};
        const uzKeys = Object.keys(uzDs);
        // Joriy til ro'yxati (label sifatida ko'rsatamiz)
        const langDs   = fullDs ? (fullDs[lang] || fullDs['uz'] || {}) : {};
        const langKeys = Object.keys(langDs);

        // 2. Viloyat - value=uzKey, label=langKey
        if (region && uzKeys.length) {
          const regionOpts = uzKeys.map((uzKey, i) => ({
            value: uzKey,
            label: langKeys[i] || uzKey
          }));
          rebuildLocOptions('inp-region', regionOpts, true);
          showLocationWrap('inp-region');
          ...
          const rLabel = _translateGenericRegion(region, lang) || region;
          const rValEl = document.getElementById('inp-region-trigger-val');
          if (rValEl) { rValEl.textContent = rLabel; rValEl.classList.remove('placeholder'); }
        ...
        // 3. Tuman - value=uzDistrict, label=langDistrict
        if (district && region) {
          const uzDistList = uzDs[region] || [];
          const uzIdx      = uzKeys.indexOf(region);
          const langDistList = (uzIdx !== -1 && langKeys[uzIdx])
            ? (langDs[langKeys[uzIdx]] || uzDistList)
            : uzDistList;

          if (uzDistList.length) {
            const distOpts = uzDistList.map((uzD, i) => ({
              value: uzD,
              label: langDistList[i] || uzD
            }));
            rebuildLocOptions('inp-district', distOpts, false);
            showLocationWrap('inp-district');
            ...
            const dLabel = _translateGenericDistrict(district, lang) || district;
            const dValEl = document.getElementById('inp-district-trigger-val');
            if (dValEl) { dValEl.textContent = dLabel; dValEl.classList.remove('placeholder'); }
      ...
      try {
        ...
        */
        ...
        if (matched) {
          ...
          // Geo-status xabarini o'zbek tilidagi tarjimada ko'rsatish
          const lang = currentLang || 'uz';
          const districtLabel  = matched.district ? (_translateGenericDistrict(matched.district, lang) || matched.district) : '';
          const regionLabel    = matched.region   ? (_translateGenericRegion(matched.region, lang)     || matched.region)   : '';
          const countryLabel   = matched.country  ? (_translateCountryValue(matched.country, lang)      || matched.country)  : '';
          const geoDisplayParts = [districtLabel, regionLabel, countryLabel].filter(Boolean);
          const geoDisplayText  = geoDisplayParts.length > 0 ? geoDisplayParts.join(', ') : locationName;

          const geoStatus = document.getElementById('geo-status');
          if (geoStatus) {
            geoStatus.style.display = 'flex';
            geoStatus.textContent = tr('geo_success') + ': ' + geoDisplayText;
          }
          showMapResult(geoDisplayText);
          selectedLocationName = geoDisplayText;
        } else {
