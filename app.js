  ...
  // initLanguage - Promise qaytaradi, DOMContentLoaded await qilishi uchun
    ...
    function showLocationWrap(id) {
      ...
      if (wrap) { wrap.style.display = 'block'; wrap.style.animation = 'none'; setTimeout(() => { wrap.style.animation = ''; }, 10); }
    ...
    function markLocationFilled(wrapId, filled) {
    ...
    function updateLocationSteps(prefix, step) {
      // step: 1=country selected, 2=region selected, 3=district selected
      for (let i = 1; i <= 3; i++) {
    ...
    function onCountryChange() {
      ...
      markLocationFilled('inp-country', !!country);
    ...
    function onRegionChange() {
      ...
      markLocationFilled('inp-region', !!region);
    ...
    function onDistrictChange() {
      ...
      markLocationFilled('inp-district', !!district);
    ...
    function onSearchCountryChange() {
      ...
      markLocationFilled('sf-country', !!country);
    ...
    function onSearchRegionChange() {
      ...
      markLocationFilled('sf-region', !!region);
