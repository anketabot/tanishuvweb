const tg = window.Telegram?.WebApp;
  ...
  'uz': {
    ...
    'zodiac_qoy': "Qo'y", 'zodiac_buzoq': 'Buzoq', 'zodiac_egizak': 'Egizak',
    'zodiac_qisqichbaqa': 'Qisqichbaqa', 'zodiac_arslon': 'Arslon', 'zodiac_sunbula': 'Sunbula',
    'zodiac_tarozi': 'Tarozi', 'zodiac_chayon': 'Chayon', 'zodiac_oqotar': "O'qotar",
    'zodiac_tog_echkisi': "Tog' echkisi", 'zodiac_qovga': "Qovg'a", 'zodiac_baliq': 'Baliq',
    'interests': 'Qiziqishlar',
    'int_kino': 'Kino', 'int_musiqa': 'Musiqa', 'int_kitob': "Kitob o'qish",
    'int_oyinlar': "O'yinlar", 'int_teatr': 'Teatr', 'int_muzeylar': 'Muzeylar',
    'int_sanat': "San'at", 'int_foto': 'Foto', 'int_sheiriyat': "She'riyat",
    'int_raqs': 'Raqs', 'int_sport': 'Sport', 'int_yoga': 'Yoga',
    'int_sayr': 'Sayr', 'int_sayohat': 'Sayohat', 'int_plyaj': 'Plyaj',
    'int_shopping': 'Shopping', 'int_moda': 'Moda', 'int_qahva': 'Qahva',
    'int_vino': 'Vino', 'int_pivo': 'Pivo', 'int_blog': 'Blog yuritish',
    'int_dasturlash': 'Dasturlash', 'int_shaxmat': 'Shaxmat', 'int_rasm': 'Rasm chizish',
    'int_tillar': "Tillar o'rganish",
    'your_goal': 'Maqsadingiz',
    "goal_do'stlik": "Do'stlik", 'goal_tanishuv': 'Tanishuv', 'goal_ola': 'Oila',
    'goal_sevgi': 'Sevgi', 'goal_romantika': 'Romantika', 'goal_uhrashuv': 'Uchrashuv',
    'goal_virtual': 'Virtual muloqot', 'goal_boshqa': 'Boshqa',
    'photo': 'Fotosurat',
    ...
    'check_likes': "Like'laringizni tekshiring",
    ...
    'send': '📨 Xabar yuborish',
    'match_title': 'Match!',
    'match_sub': 'Endi muloqot boshlashingiz mumkin',
    'awesome': 'Ajoyib!',
    'daily_limit_ended': 'Kunlik limit tugadi',
    'limit_ended_desc': 'Sizning kunlik limitingiz tugadi.',
  ...
  'ru': {
    ...
    'zodiac_qoy': 'Овен', 'zodiac_buzoq': 'Телец', 'zodiac_egizak': 'Близнецы',
    'zodiac_qisqichbaqa': 'Рак', 'zodiac_arslon': 'Лев', 'zodiac_sunbula': 'Дева',
    'zodiac_tarozi': 'Весы', 'zodiac_chayon': 'Скорпион', 'zodiac_oqotar': 'Стрелец',
    'zodiac_tog_echkisi': 'Козерог', 'zodiac_qovga': 'Водолей', 'zodiac_baliq': 'Рыбы',
    'interests': 'Интересы',
    'int_kino': 'Кино', 'int_musiqa': 'Музыка', 'int_kitob': 'Чтение книг',
    'int_oyinlar': 'Игры', 'int_teatr': 'Театр', 'int_muzeylar': 'Музеи',
    'int_sanat': 'Искусство', 'int_foto': 'Фото', 'int_sheiriyat': 'Поэзия',
    'int_raqs': 'Танцы', 'int_sport': 'Спорт', 'int_yoga': 'Йога',
    'int_sayr': 'Прогулки', 'int_sayohat': 'Путешествия', 'int_plyaj': 'Пляж',
    'int_shopping': 'Шопинг', 'int_moda': 'Мода', 'int_qahva': 'Кофе',
    'int_vino': 'Вино', 'int_pivo': 'Пиво', 'int_blog': 'Ведение блога',
    'int_dasturlash': 'Программирование', 'int_shaxmat': 'Шахматы', 'int_rasm': 'Рисование',
    'int_tillar': 'Изучение языков',
    'your_goal': 'Ваша цель',
    "goal_do'stlik": 'Дружба', 'goal_tanishuv': 'Знакомство', 'goal_ola': 'Семья',
    'goal_sevgi': 'Любовь', 'goal_romantika': 'Романтика', 'goal_uhrashuv': 'Свидания',
    'goal_virtual': 'Виртуальное общение', 'goal_boshqa': 'Другое',
    'photo': 'Фото',
    ...
    'check_likes': 'Проверьте свои лайки',
    ...
    'match_sub': 'Теперь вы можете общаться',
    'awesome': 'Отлично!',
    'daily_limit_ended': 'Дневной лимит исчерпан',
    'limit_ended_desc': 'Ваш дневной лимит исчерпан.',
  ...
  'kk': {
    ...
    'zodiac_qoy': 'Тоқан', 'zodiac_buzoq': 'Торпақ', 'zodiac_egizak': 'Егіздер',
    'zodiac_qisqichbaqa': 'Шаян', 'zodiac_arslon': 'Арыстан', 'zodiac_sunbula': 'Бикеш',
    'zodiac_tarozi': 'Таразы', 'zodiac_chayon': 'Сараян', 'zodiac_oqotar': 'Мерген',
    'zodiac_tog_echkisi': 'Тауешкі', 'zodiac_qovga': 'Суқұйғыш', 'zodiac_baliq': 'Балықтар',
    'interests': 'Қызығушылықтар',
    'int_kino': 'Кино', 'int_musiqa': 'Музыка', 'int_kitob': 'Кітап оқу',
    'int_oyinlar': 'Ойындар', 'int_teatr': 'Театр', 'int_muzeylar': 'Мұражайлар',
    'int_sanat': 'Өнер', 'int_foto': 'Фото', 'int_sheiriyat': 'Поэзия',
    'int_raqs': 'Би', 'int_sport': 'Спорт', 'int_yoga': 'Йога',
    'int_sayr': 'Серуен', 'int_sayohat': 'Саяхат', 'int_plyaj': 'Жағажай',
    'int_shopping': 'Шопинг', 'int_moda': 'Сән', 'int_qahva': 'Кофе',
    'int_vino': 'Шарап', 'int_pivo': 'Сыра', 'int_blog': 'Блог жүргізу',
    'int_dasturlash': 'Бағдарламалау', 'int_shaxmat': 'Шахмат', 'int_rasm': 'Сурет салу',
    'int_tillar': 'Тіл үйрену',
    'your_goal': 'Мақсатыңыз',
    "goal_do'stlik": 'Достық', 'goal_tanishuv': 'Танысу', 'goal_ola': 'Отбасы',
    'goal_sevgi': 'Махаббат', 'goal_romantika': 'Романтика', 'goal_uhrashuv': 'Кездесу',
    'goal_virtual': 'Виртуалды қарым-қатынас', 'goal_boshqa': 'Басқа',
    'photo': 'Фото',
    ...
    'check_likes': 'Лайктеріңізді тексеріңіз',
    'conversations': '💬 Әңгімелер',
    'no_chats': 'Әзірше чаттар жоқ',
    'no_chats_hint': 'Іздеу бөліміне жаңа достар табыңыз және лайк басыңыз!',
    ...
    'match_sub': 'Енді сөйлесе аласыз',
    'awesome': 'Тамаша!',
    'daily_limit_ended': 'Күнделікті лимит бітті',
    'limit_ended_desc': 'Сіздің күнделікті лимитіңіз бітті.',
  ...
  'ky': {
    ...
    'zodiac_qoy': 'Коюн', 'zodiac_buzoq': 'Бука', 'zodiac_egizak': 'Эгиздер',
    'zodiac_qisqichbaqa': 'Бөйөн', 'zodiac_arslon': 'Арстан', 'zodiac_sunbula': 'Бийкеч',
    'zodiac_tarozi': 'Тараза', 'zodiac_chayon': 'Чаян', 'zodiac_oqotar': 'Жаачы',
    'zodiac_tog_echkisi': 'Тоо теке', 'zodiac_qovga': 'Суу куюучу', 'zodiac_baliq': 'Балыктар',
    'interests': 'Кызыгуулар',
    'int_kino': 'Кино', 'int_musiqa': 'Музыка', 'int_kitob': 'Китеп окуу',
    'int_oyinlar': 'Оюндар', 'int_teatr': 'Театр', 'int_muzeylar': 'Музейлер',
    'int_sanat': 'Өнөр', 'int_foto': 'Фото', 'int_sheiriyat': 'Поэзия',
    'int_raqs': 'Бий', 'int_sport': 'Спорт', 'int_yoga': 'Йога',
    'int_sayr': 'Сейил', 'int_sayohat': 'Саякат', 'int_plyaj': 'Пляж',
    'int_shopping': 'Шопинг', 'int_moda': 'Мода', 'int_qahva': 'Кофе',
    'int_vino': 'Шарап', 'int_pivo': 'Сыра', 'int_blog': 'Блог жүргүзүү',
    'int_dasturlash': 'Программалоо', 'int_shaxmat': 'Шахмат', 'int_rasm': 'Сүрөт тартуу',
    'int_tillar': 'Тил үйрөнүү',
    'your_goal': 'Максатыңыз',
    "goal_do'stlik": 'Достук', 'goal_tanishuv': 'Таанышуу', 'goal_ola': 'Үй-бүлө',
    'goal_sevgi': 'Сүйүү', 'goal_romantika': 'Романтика', 'goal_uhrashuv': 'Жолугушуу',
    'goal_virtual': 'Виртуалдык баарлашуу', 'goal_boshqa': 'Башка',
    'photo': 'Сүрөт',
    ...
    'check_likes': 'Лайктарыңызды текшериңиз',
    ...
    'send': '📨 Жөнөтүү',
    'match_title': 'Шайкештик!',
    'match_sub': 'Эми баарлаша аласыз',
    'awesome': 'Сонун!',
    'daily_limit_ended': 'Күндөлүк лимит бүттү',
    'limit_ended_desc': 'Сиздин күндөлүк лимитиңиз бүттү.',
  ...
  'kaa': {
    ...
    'zodiac_qoy': 'Qoshqar', 'zodiac_buzoq': 'Buǵa', 'zodiac_egizak': 'Ekizler',
    'zodiac_qisqichbaqa': 'Shayan', 'zodiac_arslon': 'Arıslan', 'zodiac_sunbula': 'Bikesh',
    'zodiac_tarozi': 'Taraǵı', 'zodiac_chayon': 'Shayan', 'zodiac_oqotar': 'Merjen',
    'zodiac_tog_echkisi': 'Taw eshki', 'zodiac_qovga': 'Sıwqúyǵısh', 'zodiac_baliq': 'Balıqlar',
    'interests': 'Qızıǵıwshılıqlar',
    'int_kino': 'Kino', 'int_musiqa': 'Muzıka', 'int_kitob': 'Kitap oqıw',
    'int_oyinlar': 'Oyınlar', 'int_teatr': 'Teatr', 'int_muzeylar': 'Muzeylar',
    'int_sanat': 'Óner', 'int_foto': 'Foto', 'int_sheiriyat': 'Poeziya',
    'int_raqs': 'Bi', 'int_sport': 'Sport', 'int_yoga': 'Yoga',
    'int_sayr': 'Sayr', 'int_sayohat': 'Sayaxat', 'int_plyaj': 'Plyaj',
    'int_shopping': 'Shoping', 'int_moda': 'Moda', 'int_qahva': 'Qahwa',
    'int_vino': 'Vino', 'int_pivo': 'Pivo', 'int_blog': 'Blog júrgiziw',
    'int_dasturlash': 'Programmalaw', 'int_shaxmat': 'Shaxmat', 'int_rasm': 'Súwret sızıw',
    'int_tillar': 'Til úyreniw',
    'your_goal': 'Maqsetińiz',
    "goal_do'stlik": 'Doslıq', 'goal_tanishuv': 'Tanısıw', 'goal_ola': 'Shanıraq',
    'goal_sevgi': 'Máhabbat', 'goal_romantika': 'Romantika', 'goal_uhrashuv': 'Usırasıw',
    'goal_virtual': 'Virtual mıńgılasıw', 'goal_boshqa': 'Basqa',
    'photo': 'Foto súwret',
    ...
    'search': 'Izlew',
    'search_results': 'Izlew nátiyjeleri',
    ...
    'check_likes': 'Layklarıńızdı tekseriń',
    ...
    'match_sub': 'Endi sóylese alasız',
    'awesome': 'Keremet!',
    'daily_limit_ended': 'Kúndelik limit túgedi',
    'limit_ended_desc': 'Sizdiń kúndelik limitińiz túgedi.',
  ...
  'tg': {
    ...
    'zodiac_qoy': 'Ҳамал', 'zodiac_buzoq': 'Савр', 'zodiac_egizak': 'Ҷавзо',
    'zodiac_qisqichbaqa': 'Саратон', 'zodiac_arslon': 'Асад', 'zodiac_sunbula': 'Сунбула',
    'zodiac_tarozi': 'Мезон', 'zodiac_chayon': 'Ақраб', 'zodiac_oqotar': 'Қавс',
    'zodiac_tog_echkisi': 'Ҷаддӣ', 'zodiac_qovga': 'Далв', 'zodiac_baliq': 'Ҳут',
    'interests': 'Шавқҳо',
    'int_kino': 'Кино', 'int_musiqa': 'Мусиқӣ', 'int_kitob': 'Китобхонӣ',
    'int_oyinlar': 'Бозиҳо', 'int_teatr': 'Театр', 'int_muzeylar': 'Музейҳо',
    'int_sanat': 'Санъат', 'int_foto': 'Сурат', 'int_sheiriyat': 'Шеър',
    'int_raqs': 'Рақс', 'int_sport': 'Варзиш', 'int_yoga': 'Йога',
    'int_sayr': 'Сайр', 'int_sayohat': 'Саёҳат', 'int_plyaj': 'Пляж',
    'int_shopping': 'Шопинг', 'int_moda': 'Мода', 'int_qahva': 'Қаҳва',
    'int_vino': 'Шароб', 'int_pivo': 'Пиво', 'int_blog': 'Блогнависӣ',
    'int_dasturlash': 'Барномасозӣ', 'int_shaxmat': 'Шоҳмот', 'int_rasm': 'Расмкашӣ',
    'int_tillar': 'Омӯзиши забонҳо',
    'your_goal': 'Мақсади шумо',
    "goal_do'stlik": 'Дӯстӣ', 'goal_tanishuv': 'Шиносоӣ', 'goal_ola': 'Оила',
    'goal_sevgi': 'Муҳаббат', 'goal_romantika': 'Романтика', 'goal_uhrashuv': 'Вохӯрӣ',
    'goal_virtual': 'Муоширати виртуалӣ', 'goal_boshqa': 'Дигар',
    'photo': 'Сурат',
    ...
    'check_likes': 'Лайкҳои худро санҷед',
    ...
    'match_sub': 'Акнун метавонед гуфтугӯ кунед',
    'awesome': 'Аҷоиб!',
    'daily_limit_ended': 'Лимити ҳаррӯза тамом шуд',
    'limit_ended_desc': 'Лимити ҳаррӯзаи шумо тамом шуд.',
  ...
  function applyTranslations() {
    ...
    document.querySelectorAll('[data-i18n]').forEach(el => {
      ...
      const text = tr(key);
      if (text && text !== key) {
        // Agar ichida <span data-i18n="..."> bo'lsa, faqat matn qismini almashtirish
        const childI18n = el.querySelector('[data-i18n]');
        if (!childI18n) {
          el.textContent = text;
        }
      }
    ...
    // 3. <title> ni yangilash
    const titleEl = document.querySelector('title[data-i18n]');
    if (titleEl) {
      document.title = tr(titleEl.getAttribute('data-i18n')) || document.title;
    }
    
    // 4. Burj tanlovlarini qayta sync qilish
    if (typeof syncZodiacPicker === 'function') syncZodiacPicker();
    if (typeof syncSearchZodiacPicker === 'function') syncSearchZodiacPicker();
  }
  ...
  document.addEventListener('DOMContentLoaded', async () => {
    ...
    // 1. Tilni AVVAL yuklash
    await initLanguage();
    
    // 2. Tarjimalarni qo'llash
    applyTranslations();
    ...
    if (userId) {
      ...
      // Tilni qayta qo'llash (backend'dan kelgan til bilan)
      applyTranslations();
    } else {
      resetProfileFormState();
      showPage('profile');
